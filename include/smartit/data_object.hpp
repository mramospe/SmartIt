...
namespace smit {
  ...
  public:
    ...
    public:
      ...
      explicit iterator(const Iterators &... args)
          : tuple_type{args...}, m_container{*this} {}

      /// Constructors for cases with no arguments (default) and with
      /// iterators
      template <class... UIterators>
      iterator(UIterators &&... args)
          : tuple_type{args...}, m_container{*this} {}
  ...
  /// Determine the value type of two or more template arguments to a prototype
  /// class
